...
//        getRef().displayClientMessage(message, true);
    ...
    public boolean canInteractBlock(BlockPosition blockPosition) {
        return !reference.blockActionRestricted(reference.getLevel(), MinecraftPrimitives.toMinecraftBlockPosition(blockPosition), switch (getGameType()) {
    ...
    public boolean canAttackBlock(BlockPosition blockPosition) {
        return reference.getMainHandItem().getItem().canAttackBlock(reference.getLevel().getBlockState(MinecraftPrimitives.toMinecraftBlockPosition(blockPosition)), reference.getLevel(), MinecraftPrimitives.toMinecraftBlockPosition(blockPosition), reference);
    }
