...
//	}
    ...
    public void renderWidget(Renderer renderer, int mouseX, int mouseY, float deltaTick) {
        ...
        if (this.isBordered()) {
            ...
            renderer.drawRect(this.getX() - 1, this.getY() - 1, this.getX() + this.getWidth() + 1, this.getY() + this.getHeight() + 1, k);
    ...
    private void renderHighlight(Renderer renderer, int i, int j, int k, int l) {
        ...
        renderer.drawRect(renderer.getStyleProvider().guiTextHighlight(), i, j, k, l, -16776961);
    }
