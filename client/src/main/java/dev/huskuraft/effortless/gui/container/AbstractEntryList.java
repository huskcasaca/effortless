...
public abstract class AbstractEntryList<E extends AbstractEntryList.Entry> extends AbstractContainerWidget implements EntryList, Tickable {
    ...
    public void renderWidget(Renderer renderer, int mouseX, int mouseY, float deltaTick) {
        ...
        if (this.renderShadow) {
            renderer.renderGradientRect(renderer.renderTextures().guiOverlay(), this.x0, this.y0, this.x1, this.y0 + 4, -16777216, 0, 0);
            renderer.renderGradientRect(renderer.renderTextures().guiOverlay(), this.x0, this.y1 - 4, this.x1, this.y1, 0, -16777216, 0);
        }
