package dev.huskuraft.effortless.gui.selection;
...
public class RadialSection<S, B> extends AbstractWidget {
    ...
    private void renderRadialSlots(Renderer renderer, int mouseX, int mouseY, List<? extends Slot<S>> slots) {
        ...
        for (int i = 0; i < slots.size(); i++) {
            ...
            if (isHovered) {
                ...
                int textY = (int) (y * RadialSection.TEXT_DISTANCE) - getTypeface().getLineHeight() / 2;
