...
public class BlockBoundingBoxOutline extends Outline {
    ...
    protected void renderFace(Renderer renderer, Orientation orientation, Vector3d p1, Vector3d p2,
        ...
        var renderLayer = renderer.outlineRenderLayers().outlineTranslucent(faceTexture, !noCull);
        renderer.pushLayer();
        ...
        renderer.drawQuadUV(renderLayer, p1, p2, p3, p4, 0, 0, maxU, maxV, getParams().getLightMap(), getParams().getColor().getRGB(), Orientation.UP);
