...
public final class DoubleSettingsEntry extends SettingsEntry<Double> {

    private NumberField numberField;

    public DoubleSettingsEntry(Entrance entrance, EntryList entryList, Text title, Text symbol, Double value, Consumer<Double> consumer) {
