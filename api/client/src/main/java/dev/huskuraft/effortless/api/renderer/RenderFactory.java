...
public interface RenderFactory {
    ...
    RenderLayer createCompositeRenderLayer(String name,
    ...
    CompositeRenderState createCompositeState(
    ...
    RenderState.TextureState createTextureState(String name);
    RenderState.TextureState createTextureState(String name,
                                                RenderState.TextureState.Texture texture);
    RenderState.ShaderState createShaderState(String name,
                                              Shader shader);
    ...
    RenderState.LineState createLineState(String name);
