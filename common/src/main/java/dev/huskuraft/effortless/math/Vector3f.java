...
public class Vector3f {
    ...
    public Vector3f floor() {
        return Vector3f.at(MathUtils.floor(x), MathUtils.floor(y), MathUtils.floor(z));
    }
    ...
    public Vector3f ceil() {
        return Vector3f.at(MathUtils.ceil(x), MathUtils.ceil(y), MathUtils.ceil(z));
    }
    ...
    public Vector3f round() {
        return Vector3f.at(MathUtils.floor(x + 0.5), MathUtils.floor(y + 0.5), MathUtils.floor(z + 0.5));
    }
     ...
     */
    public Vector3f abs() {
        return Vector3f.at(MathUtils.abs(x), MathUtils.abs(y), MathUtils.abs(z));
    }
