...
public class Vector4f {
    ...
    public Vector4f floor() {
        return Vector4f.at(MathUtils.floor(x), MathUtils.floor(y), MathUtils.floor(z), MathUtils.floor(w));
    }
    ...
    public Vector4f ceil() {
        return Vector4f.at(MathUtils.ceil(x), MathUtils.ceil(y), MathUtils.ceil(z), MathUtils.ceil(w));
    }
    ...
    public Vector4f round() {
        return Vector4f.at(MathUtils.floor(x + 0.5), MathUtils.floor(y + 0.5), MathUtils.floor(z + 0.5), MathUtils.floor(w + 0.5));
    }
     ...
     */
    public Vector4f abs() {
        return Vector4f.at(MathUtils.abs(x), MathUtils.abs(y), MathUtils.abs(z), MathUtils.abs(w));
    }
